"""
Django settings for OrderPoint project.
...
AUTHENTICATION_BACKENDS = [
    'api.backends.CustomOIDCAuthenticationBackend',
...
WSGI_APPLICATION = 'OrderPoint.wsgi.application'
